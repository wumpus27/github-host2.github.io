...
function set_es(object) {
  if (object.checked) {
    document.querySelector(':root').style.setProperty('--dashboardw', 'blue');
  } else {
    document.querySelector(':root').style.setProperty('--dashboardh', 'red');
  }
}
